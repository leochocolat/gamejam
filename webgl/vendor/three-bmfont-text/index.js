...
class TextGeometry extends Base {
    ...
    update(opt) {
        ...
        const attributes = vertices.attributes(glyphs, texWidth, texHeight, flipY);
        const infos = vertices.infos(glyphs);
    ...
    computeBoundingSphere() {
        ...
        const positions = this.attributes.position2.array;
        const itemSize = this.attributes.position2.itemSize;
